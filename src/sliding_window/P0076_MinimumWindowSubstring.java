...
public class P0076_MinimumWindowSubstring {
    ...
    public String minWindow(String s, String t) {
            ...
            while(right < s.length()){
                ...
                // 这里和下面都有个坑，window.get(addChar)和need.get(addChar)返回的都是对象，
                // 最好用.equals()方法比较大小
                ...
                while(valid == need.size()){
                    ...
                    if(right - left < len){  // 注意，这里上面已经对right实施了++操作，
                        // 所以这里的长度不是right - left + 1
                        len = right - left ;
                    ...
                    if(need.containsKey(removeChar) && window.get(removeChar)
                            .equals(need.get(removeChar))){
                        valid--;
                    }
